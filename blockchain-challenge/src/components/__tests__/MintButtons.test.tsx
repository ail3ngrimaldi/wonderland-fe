...
describe('MintButtons', () => {
  ...
  describe('When connected to Sepolia', () => {
    ...
    it('should show success state after successful mint', () => {
      mockUseWaitForTransactionReceipt.mockReturnValue(createMockUseWaitForTransactionReceipt({
        isLoading: false,
        isSuccess: true,
      ...
      expect(screen.getByText('Seeds Planted Successfully!')).toBeInTheDocument()
  ...
  describe('Error handling', () => {
    ...
    it('should display error message when mint fails', () => {
      ...
      expect(screen.getByText('Eco-token couldnt be created :(')).toBeInTheDocument()
    ...
    it('should show receipt error when transaction confirmation fails', () => {
      ...
      expect(screen.getByText('Unable to confirm planting :')).toBeInTheDocument()
